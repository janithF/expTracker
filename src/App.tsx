...
function App() {
  ...
  return (
    <div id="expense-tracker" className="flex h-full border bg-background border-gray-200 border-solid rounded-[25px]">
      ...
      <div id="main-container" className="flex-1 rounded-[25px] py-[5px] px-[12px] bg-white">
